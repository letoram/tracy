...
if (NOT NO_FILESELECTOR AND NOT EMSCRIPTEN)
    ...
    elseif (APPLE)
        set(NFD_SOURCES "${NFD_DIR}/nfd_cocoa.m")
		    ...
		    if (USE_ARCAN)
            set(NFD_SOURCES "${NFD_DIR}/nfd_arcan.cpp")
				elseif (GTK_FILESELECTOR)
    ...
    elseif (UNIX)
        if (GTK_FILESELECTOR)
            ...
            target_link_libraries(TracyNfd PUBLIC TracyGtk3)
					elseif (USE_ARCAN)
					  pkg_check_modules(ARCAN arcan-shmif)
						if (NOT_ARCAN_FOUND)
							message(FATAL_ERROR "Arcan not found. Pleace install it or set TRACY_USE_ARCAN to OFF.")
						endif()
						add_library(TracyArcan INTERFACE)
						target_include_directories(TracyArcan INTERFACE ${ARCAN_INCLUDE_DIRS})
						target_link_libraries(TracyArcan INTERFACE ${ARCAN_LIBRARIES})
						target_link_libraries(TracyNfd PUBLIC TracyArcan)

				  # the regular platform is responsible
					else()
